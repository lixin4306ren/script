...
my $cmd="cat $ARGV[0]|cut -f1-4|/home/jhmi/xinli/bin/genomic_scans counts -min 0 -i -v -op c -w $window -d $step -g $chr_len|/home/jhmi/xinli/bin/genomic_regions bed > $tmp_file.tmp1";
print "$cmd\n";
`$cmd`;
$cmd="cat $ARGV[1]|cut -f1-4|/home/jhmi/xinli/bin/genomic_scans counts -min 0 -i -v -op c -w $window -d $step -g $chr_len|/home/jhmi/xinli/bin/genomic_regions bed > $tmp_file.tmp2";
`$cmd`;
print "$cmd\n";
